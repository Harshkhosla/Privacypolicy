    ...
    return (
        <div className="privacy-policy-container">
            ...
            <ul>
                ...
                <li><strong>Application</strong> refers to Jouls Connect, the software program provided by the Company.</li>
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Jouls Ecotech Pvt. Ltd., 117,SF, Block-C,South City 2, Sector 49, Gurugram, Haryana, IN 122018.</li>
            ...
            <ul>
                ...
                <li>
                    ...
                    other users, such information may be viewed by all users and may be publicly distributed outside. If You interact
                    with other users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social
                    Media Service may see Your name, profile, pictures and description of Your activity. Similarly, other users will be
            ...
            <ul>
                ...
                <li>By visiting this page on our website: <a href="https://www.jouls.energy/" target="_blank" rel="noopener noreferrer">https://www.jouls.energy/</a></li>
                <li>By phone number: 6377650430</li>
            </ul>
        </div>
    );
};
