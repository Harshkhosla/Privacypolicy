...
const PrivacyPolicy = () => {
    return (
        <div className="privacy-policy-container">
            ...
            <p>
                This Privacy Policy describes how JOULS ECOTECH PRIVATE LIMITED and its affiliates 
                (collectively "JOULS ECOTECH PRIVATE LIMITED, we, our, us") collect, use, share, protect or 
                otherwise process your information/ personal data through our website https://play.google.com/store
                /apps/details?id=com.Jouls (hereinafter referred to as Platform). Please note that you may be able to 
            ...
            <p>
                ...
                This information is compiled and analyzed on an aggregated basis. We will also collect your information 
                ...
                any information. If you receive an email, a call from a person/association claiming to be JOULS 
                ECOTECH PRIVATE LIMITED seeking any personal data like debit/credit card PIN, net-banking or 
            ...
            <p>
                ...
                payment opted by you. These disclosures may be required for us to provide you access to our services and 
                ...
                agencies or other authorized law enforcement agencies if required to do so by law or in the good faith 
                belief that such disclosure is reasonably necessary to respond to subpoenas, court orders, or other legal 
                processes. We may disclose personal data to law enforcement offices, third party rights owners, or others in 
            ...
            <p>
                To protect your personal data from unauthorized access or disclosure, loss or 
                ...
                protect it against unauthorized access and offer the use of a secure server. However, the transmission of 
            ...
            <p>
                ...
                continue to retain your data in anonymized form for analytical and research purposes.
            </p>
            ...
            <p>
                2. This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://play.google.com/store/apps/details?id=com.Jouls ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
            </p>
            <p>
                3. The Platform is owned by JOULS ECOTECH PRIVATE LIMITED, a company incorporated under the Companies Act, 1956 with its registered office at GURGAON, Haryana, Gurgaon, India (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').
            </p>
            <p>
            ...
            <p>
                11. All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Gurgaon and Haryana.
            </p>
            <p>
            ...
            <h2>Refund Policy</h2>
            <p>
                In case of failure of payment, we will refund the amount within 7 days if and only if the amount is 
                deducted from the user's bank account. The following conditions apply to our refund policy:
            </p>
            <ul>
                <li>
                    <strong>Verification:</strong> The refund process will begin once we have verified that the payment failure 
                    occurred and that the amount was indeed deducted from the user's bank account.
                </li>
                <li>
                    <strong>Notification:</strong> Users must notify us of the payment failure within 3 days of the transaction date 
                    by contacting our customer support team with relevant transaction details.
                </li>
                <li>
                    <strong>Documentation:</strong> Users may be required to provide documentation such as bank statements 
                    or transaction receipts to assist in verifying the payment failure.
                </li>
                <li>
                    <strong>Processing Time:</strong> After verification, the refund will be processed within 7 business days. 
                    The refunded amount will be credited back to the original payment method used by the user.
                </li>
                <li>
                    <strong>Non-Refundable Cases:</strong> Refunds will not be issued for failed transactions where the amount 
                    has not been deducted from the user's bank account or where the failure is due to issues on the user's end 
                    such as insufficient funds or incorrect payment details.
                </li>
                <li>
                    <strong>Service Charges:</strong> Any applicable service charges or fees related to the refund process may be 
                    deducted from the refund amount, if applicable.
                </li>
                <li>
                    <strong>Customer Support:</strong> For any queries or assistance related to payment failures and refunds, 
                    users can contact our customer support team through the contact information provided on our Platform.
                </li>
            </ul>
            <p>
                We strive to ensure a smooth and transparent refund process. Our customer support team is dedicated to 
                resolving any issues related to payment failures promptly and efficiently.
            </p>
            ...
            <p>Jouls Ecotech </p>
            <p>Contact us: +91-6377650430</p>
            <p>Time: Monday - Sunday (24*7)</p>
        </div>
    );
};
